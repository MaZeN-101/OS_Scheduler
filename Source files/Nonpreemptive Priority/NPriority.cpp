...
float NPriority(int num_of_processes, process_struct* process)
{
    ...
    system("dot -Tpng NPriority.dot -o NPriority.png");

    system("NPriority.png");
